...
#  needs NVFP4 swizzle padding, unsupported for gated experts. On this box no pure-TP config
#  fits at all; fallback candidate: TP=4 EP_SIZE=4 — uses only 4 cards, untested.)

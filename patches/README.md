...
Apply all eight with the idempotent helper (safe to re-run after every `git pull` of this repo):
...
0007–0008 are TP8/EP8 deployment fixes found while bringing up the 8× RTX 5090 box (both
